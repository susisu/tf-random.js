...
export function threefish256EncryptBlock(key, block, uint32out) {
  ...
  function injectKey(r) {
    x0 = (x0 + ks[r       % (SKEIN_256_STATE_WORDS + 1)]) & MAX_BIG_UINT64;
    x1 = (x1 + ks[(r + 1) % (SKEIN_256_STATE_WORDS + 1)]) & MAX_BIG_UINT64;
    x2 = (x2 + ks[(r + 2) % (SKEIN_256_STATE_WORDS + 1)]) & MAX_BIG_UINT64;
    x3 = (x3 + ks[(r + 3) % (SKEIN_256_STATE_WORDS + 1)] + BigInt(r)) & MAX_BIG_UINT64;
  }
